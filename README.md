...
In our [previous pub](https://doi.org/10.57844/arcadia-1e5d-e272) on the Deoxycytidine Kinase (dCK) protein family, we outlined a plan for using dCKs to validate the results of ProteinCartography, and we describe in detail why we chose to use this family for our analysis. As part of this pub, we analyzed the resulting clusters and proposed a tentative strategy for selecting individual clusters and proteins to bring into the lab to study their biochemical function.
